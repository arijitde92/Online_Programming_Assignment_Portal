...
class Assignment(db.Model):
    ...
    questions = db.relationship(
        "Question", backref="assignment", cascade="all, delete", lazy=True
    )
...
class Question(db.Model):
    ...
    testcases = db.relationship(
        "Testcase", backref="question", cascade="all, delete", lazy=True
    )
...
class Submission(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    st_id = db.Column(
        db.Integer, db.ForeignKey("student.id")
    )  # Updated foreign key reference
    ...
    test_case_id = db.Column(
        db.Integer, db.ForeignKey("testcase.id")
    )  # Updated foreign key reference
